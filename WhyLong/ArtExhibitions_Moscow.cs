...
namespace WhyLong
{
    public partial class ArtExhibitions_Moscow : Form
    {
        public ArtExhibitions_Moscow()
        {
            InitializeComponent();
        }
        ...
        private void ArtExhibitions_Moscow_Load(object sender, EventArgs e)
        {
            //Выставки
            ...
            mapExhibition.Position = new PointLatLng(55.744382, 37.625858);
            mapExhibition.MinZoom = 1;
            mapExhibition.MaxZoom = 100;
            mapExhibition.Zoom = 13.5;

            PointLatLng pointExhibition = new PointLatLng(55.744382, 37.625858);
            ...
            mapPerformances.Position = new PointLatLng(55.759210, 37.613155);
            mapPerformances.MinZoom = 1;
            mapPerformances.MaxZoom = 100;
            mapPerformances.Zoom = 13.5;

            PointLatLng pointPerformances = new PointLatLng(55.759210, 37.613155);
            ...
            mapConcert.Position = new PointLatLng(55.761045, 37.622596);
            mapConcert.MinZoom = 1;
            mapConcert.MaxZoom = 100;
            mapConcert.Zoom = 13.5;

            PointLatLng pointConcert = new PointLatLng(55.761045, 37.622596);
            ...
            mapMasterClass.Position = new PointLatLng(55.760424, 37.572194);
            ...
            mapContest.Position = new PointLatLng(55.760424, 37.572194);
